...
namespace NinjaTrader.NinjaScript.Indicators
{
	public class SampleDrawBitmapFun : Indicator
	{
		...
		public override void OnRenderTargetChanged()
		{
			...
			fileStream = new SharpDX.IO.NativeFileStream(System.IO.Path.Combine(NinjaTrader.Core.Globals.UserDataDir, "templates/MyResources/SampleDrawBitmap.png"), SharpDX.IO.NativeFileMode.Open, SharpDX.IO.NativeFileAccess.Read);
